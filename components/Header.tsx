    ...
    <nav className="fixed top-6 left-0 right-0 z-50 flex justify-center w-full px-4">
      <div className="glass-nav rounded-full px-2 py-2 flex items-center justify-between w-full max-w-5xl h-14">
        ...
        <Link href="/" className="flex items-center pl-4">
           ...
           <span className="ml-3 text-lg font-medium text-white tracking-tight hidden sm:block">Nexus</span>
        </Link>
        ...
        {/* CTA */}
        <div className="pr-1">
            <button className="bg-white text-black hover:bg-slate-200 transition-colors px-5 py-2 rounded-full text-sm font-medium">
                Get Started
            </button>
        </div>
